...
<div class="card">
    ...
    <div class="card-body">
		<?php
		echo anchor( 'entries/manage', 'View All Entries', array( "class" => "button alt" ) );
		echo anchor( 'entries/create/' . $update_id, 'Update Details', array( "class" => "button" ) );
		$attr_delete = array(
            ...
            <div class="record-details">
                ...
                <div class="row">
                    <div class="full-width">
                        <div><b>Content</b></div>
                        <div><?= nl2br( str_split( strip_tags($content), 150 )[0] . '...'  ) ?></div>
                    </div>
                </div>
                <div class="row">
                    <div>Created At</div>
                    <div><?= date( 'l jS F Y \a\t H:i', strtotime( $created_at ) ) ?></div>
                </div>
            </div>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <div class="text-center">
                <p>
                    <button class="alt" onclick="openModal('comment-modal')">Add New Comment</button>
                </p>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
		<?= form_open( 'entries/submit_delete/' . $update_id ) ?>
        <p>Are you sure?</p>
        <p>You are about to delete an Entry record. This cannot be undone. Do you really want to do this?</p>
		<?php
