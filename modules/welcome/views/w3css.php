...
<p>The <strong><a href="w3css_containers.asp">w3-container</a></strong> class is the most important of the W3.CSS
...
<div class="w3-example">
    ...
    <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_alerts_warning" target="_blank">Try It Yourself
        &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
    ...
    <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_cards_photo" target="_blank">Try It Yourself
        &raquo;</a>
</div>
...
<div class="w3-example">
    ...
    <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3css_tables_border" target="_blank">Try It Yourself
        &raquo;</a>
</div>
...
<br><br>
<p>Modal Image:</p>
<img class="w3-hover-opacity modimgresp" src="img_nature.jpg" alt="Nature"
...
<button onclick="myAccFunc('Demo1')" class="w3-hover-dark-grey w3-light-grey w3-button w3-block w3-left-align">Open
    Section 1
</button>
...
<button onclick="myAccFunc('Demo2')" class="w3-hover-dark-grey w3-light-grey w3-button w3-block w3-left-align">Open
    Section 2
</button>
...
<button onclick="myAccFunc('Demo3')" class="w3-hover-dark-grey w3-light-grey w3-button w3-block w3-left-align">Open
    Section 3
</button>
...
<h2>W3.CSS Tabs</h2>
<p><a href="w3css_tabulators.asp"><strong>Tabs</strong></a> are perfect for single page web applications, or for web
    pages capable of displaying different subjects.</p>
<div class="w3-border">
    <div class="w3-bar w3-light-grey intronav">
        <a href="javascript:void(0)" class="w3-bar-item w3-button testbtn"
           onclick="openCity(event, 'London')">London</a>
...
<iframe src="demo_ifr_sidebar.htm" style="height:350px;width:100%;border:none;" class="w3-border" id="I2"
        name="I2"></iframe>
<hr>
...
<h2>Slideshows</h2>
<p>W3.CSS provide <a href="w3css_slideshow.asp"><strong>slideshows</strong></a> for cycling through images or other
    content:</p>
...
<h2>Lightbox</h2>
<p>Combine <a href="w3css_modal.asp">Modals</a> and <a href="w3css_slideshow.asp">Slideshows</a> to create a lightbox
    (modal image gallery):</p>
<div id="myModalLight" class="w3-modal w3-black">
    <span class="w3-text-white w3-xxlarge w3-hover-text-grey w3-container w3-display-topright cursor"
          title="Close Lightbox" onclick="closeModalLight()">&times;</span>
        ...
        <div class="w3-content" style="max-width:1200px">
            ...
            <div class="w3-row w3-black w3-center">
                <div class="w3-container w3-display-container">
                    <p id="captionLight"></p>
                    <span class="w3-display-middle w3-hover-text-grey w3-large cursor noselection" style="left:2%"
                          onclick="plusDivsLight(-1)" title="Previous image">&#10094;</span>
                    <span class="w3-display-middle w3-hover-text-grey w3-large cursor noselection" style="left:98%"
                          onclick="plusDivsLight(1)" title="Next image">&#10095;</span>
                </div>

                <div class="w3-col s4">
                    <img class="demoLight w3-opacity w3-hover-opacity-off cursor" src="img_nature_wide.jpg"
                         style="width:100%" onclick="currentDivLight(1)" alt="Nature and sunrise">
                </div>
                <div class="w3-col s4">
                    <img class="demoLight w3-opacity w3-hover-opacity-off cursor" src="img_snow_wide.jpg"
                         style="width:100%" onclick="currentDivLight(2)" alt="French Alps">
                </div>
                <div class="w3-col s4">
                    <img class="demoLight w3-opacity w3-hover-opacity-off cursor" src="img_mountains_wide.jpg"
                         style="width:100%" onclick="currentDivLight(3)" alt="Mountains and fjords">
                </div>
            </div> <!-- End row -->
        </div> <!-- End w3-content -->
...
<div class="w3-row-padding" style="margin-left:-16px;margin-right:-16px;">
    ...
    <div class="w3-col m3 s4">
        <img src="img_mountains.jpg" class="testsm w3-hover-opacity w3-border" alt="Mountains"
...
<table class="w3-table-all w3-striped w3-bordered w3-border w3-margin-top" id="myTable" style="color:#000">
    <tr>
