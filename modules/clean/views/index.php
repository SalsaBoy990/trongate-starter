...
<div x-data="{ showToc: false}" class="main-container container relative">
    ...
    <main class="content">
        ...
        <video controls title="Test Video">
            <source src="clean_module/vids/GNOME-Workspace-Switch.mp4" type="video/mp4">
        ...
        <div class="card card-4">
            ...
            <div class="box round-bottom">
                ...
                <img src="clean_module/images/img_snowtops.jpg" alt="Car">
                <p>French Alps</p>
            </div>
        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <ul class="card card-4">
            <li class="hover-gray-20 relative">
                ...
                <img src="clean_module/images/img_avatar2.png"
            ...
            <li class="hover-gray-20 relative">
                <img src="clean_module/images/img_avatar5.png"
            ...
            <li class="hover-gray-20 relative">
                <img src="clean_module/images/img_avatar6.png"
            ...
            <li class="hover-gray-20 relative">
                <img src="clean_module/images/img_avatar3.png"
...
&lt;/ul&gt;</code></pre>
        ...
        <div class="row-padding">
            ...
            <div class="half">
                ...
                <div class="relative green">
                    <img src="clean_module/images/img_lights.jpg" alt="Lights" class="thumbnail">
                    <div class="topleft padding-1">Top Left</div>
                    <div class="topright padding-1">Top Right</div>
                    <div class="bottomleft padding-1">Bottom Left</div>
                    <div class="bottomright padding-1">Bottom Right</div>
        ...
        <div x-data="modalData">
            <img class="hover-opacity thumbnail-third pointer" src="clean_module/images/img_nature.jpg"
                 alt="Nature"
                 @click="openModal()">
            ...
            <div x-show="modal" x-cloak class="clean-modal" :class="{'show': modal}" @click="closeModal()">
                ...
                <div class="clean-modal-content content-960 card card-4 animate-zoom">
                    <img src="clean_module/images/img_nature_wide.jpg" alt="Nature">
                </div>
            </div>
        </div>
        ...
        <div x-data="accordionData">
            ...
            <div id="accordionThree" class="hide black accordion-item">
                <div class="box">
                    ...
                    <img src="clean_module/images/img_snowtops.jpg"
        ...
        <div x-data="tabbedImagesData">
                ...
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Nature');">
                        <img src="clean_module/images/img_nature.jpg" alt="Nature">
                    </a>
                </div>
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Snow');">
                        <img src="clean_module/images/img_snowtops.jpg" alt="Fjords">
                    </a>
                </div>
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Mountains');">
                        <img src="clean_module/images/img_mountains.jpg" alt="Mountains">
                    </a>
                </div>
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Lights');">
                        <img src="clean_module/images/img_lights.jpg" alt="Lights">
                    </a>
                </div>
            </div>
            <br>
            ...
            <div id="Snow" class="picture relative tabbed-image-gallery-item">
                <img src="clean_module/images/img_snow_wide.jpg" alt="Snow">
                <span @click="hide(event)"
                      class="topright close-button fs-18 transparent text-white">&times;</span>
            ...
            <div id="Mountains" class="picture relative tabbed-image-gallery-item">
                <img src="clean_module/images/img_mountains_wide.jpg" alt="Mountains">
                <span @click="hide(event)"
            ...
            <div id="Lights" class="picture relative tabbed-image-gallery-item">
                <img src="clean_module/images/img_lights_wide.jpg" alt="Lights">
                <span @click="hide(event)"
                      class="topright close-button fs-18 transparent text-white">&times;</span>
        ...
        <div x-data="sliderData" x-init="slideItemClass = 'slide-item'; slideDotsClass = 'slide-dots';"
            ...
            <div class="relative slide-item">
                <img src="clean_module/images/img_nature_wide.jpg" alt="Beautiful Nature">
            ...
            <div class="relative slide-item">
                <img src="clean_module/images/img_snow_wide.jpg" alt="French Alps">
            ...
            <div x-show="openLighbox" class="gallery-modal black" :class="{'show': openLighbox }">
                ...
                <div class="clean-modal-content content-1024">
                    ...
                    <div class="clean-content">
                        <img class="lightbox-item" src="clean_module/images/img_nature_wide.jpg"
                             alt="Nature">
                        <img class="lightbox-item" src="clean_module/images/img_snow_wide.jpg" alt="Snow">
                        <img class="lightbox-item" src="clean_module/images/img_mountains_wide.jpg"
                             alt="Mountains">
                        <div class="row black center">
                            ...
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="clean_module/images/img_nature_wide.jpg"
                                     @click="currentLightbox(1)" alt="Nature and sunrise">
                            </div>
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="clean_module/images/img_snow_wide.jpg"
                                     @click="currentLightbox(2)" alt="French Alps">
                            </div>
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="clean_module/images/img_mountains_wide.jpg"
        ...
        <div class="row-padding">
            <div class="col m3 s4">
                <img src="clean_module/images/img_lights.jpg" class="round"
                     alt="Northern Lights">
            </div>
            <div class="col m3 s4">
                <img src="clean_module/images/img_forest.jpg" class="circle" alt="Forest">
            </div>
            <div class="col m3 s4">
                <img src="clean_module/images/img_mountains.jpg" class="hover-opacity border"
                     alt="Mountains">
            </div>
        ...
        <div class="row-padding center">
            ...
            <div class="col m3 hide-mobile">
                <img src="clean_module/images/img_workshop.jpg" alt="Workshop">
                <div class="red box">
                    <p>Normal</p>
                </div>
            </div>
