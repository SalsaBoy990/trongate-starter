...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // modules/clean/_javascript/modules/data.js
  function data2() {
    return {
      scrollTop: 0,
  ...
  // modules/clean/_javascript/modules/tabsData.js
  function tabsData() {
    return {
      tabId: "",
      tabsClass: "tabs",
  ...
  // modules/clean/_javascript/modules/accordionData.js
  ...
  // modules/clean/_javascript/modules/lightboxData.js
  ...
  // modules/clean/_javascript/modules/sliderData.js
  function sliderData() {
    return {
      slideIndex: 1,
  ...
  // modules/clean/_javascript/modules/modalData.js
  function modalData() {
    return {
      modal: false,
      openModal() {
  ...
  // modules/clean/_javascript/modules/alertData.js
  function alertData() {
    return {
      openAlert: true,
      showAlert() {
  ...
  // modules/clean/_javascript/modules/progressBarData.js
  ...
  // modules/clean/_javascript/modules/animateData.js
  ...
  // modules/clean/_javascript/modules/filterData.js
  function filterData() {
    return {
      filterTerm: "",
      dataType: "table",
  ...
  // modules/clean/_javascript/modules/dropdownData.js
  ...
  // modules/clean/_javascript/modules/ajaxSearchData.js
    ...
    return {
      ...
      searchByTitle(apiPath, columnName = "title") {
        if (this.searchTerm.length >= 3) {
          ...
          fetch(apiPath + "?" + queryParams.toString(), config).then((response) => response.json()).then((data3) => {
            if (!data3) {
              return;
            }
            let newData = [];
            ...
            for (let i = 0; i < data3.length; i++) {
              let title = data3[i].title.replaceAll(stripTagsRegex, "");
              let content = data3[i].content.replaceAll(stripTagsRegex, "");
  ...
  // modules/clean/_javascript/modules/tabbedImagesData.js
  ...
  // modules/clean/_javascript/clean.js
  window.Alpine = module_default;
  module_default.data("data", data2);
  module_default.data("dropdownData", dropdownData);
  module_default.data("ajaxSearchData", ajaxSearchData);
  module_default.data("modalData", modalData);
  module_default.data("progressBarData", progressBarData);
  module_default.data("animateData", animateData);
  module_default.data("filterData", filterData);
  module_default.data("alertData", alertData);
  module_default.data("sliderData", sliderData);
  module_default.data("lightboxData", lightboxData);
  module_default.data("accordionData", accordionData);
  module_default.data("tabsData", tabsData);
  module_default.data("tabbedImagesData", tabbedImagesData);
