...
<?php
flashdata();
echo '<p>'.anchor('fruits/create', 'Create New Fruit Record', array("class" => "button")).'</p>'; 
    ...
    <table id="results-tbl">
        <thead>
            <tr>
                <th colspan="3">
                    <div>
                        <div><?php
                        echo form_open('fruits/manage/1/', array("method" => "get"));
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= anchor('fruits/show/'.$row->id, 'View', $attr) ?></td>        
            </tr>
            <?php
            }
            ?>
